...
FOOD = 0 #trạng thái thức ăn của rắn
UNDEFINED = (HEIGHT + 1) * (WIDTH + 1) #trạng thái các ô chưa được duyệt
SNAKE = 2 * UNDEFINED #trạng thái các ô thuộc thân rắn
LEFT = -1 #Trái
RIGHT = 1 #Phải
UP = -WIDTH #Trên
DOWN = WIDTH #Dưới
...
SNAKE_BLOCK = 50 #kích thước thân rắn
SNAKE_SPEED = 5 #tốc độ rắn
